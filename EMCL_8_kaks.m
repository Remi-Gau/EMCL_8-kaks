...
try
    ...
    for i_trial = 1:nb_videos
        ...
        % Load movie
        DrawFormattedText(win, 'Video algab hetke p�rast.',...
        ...
        % Type answer
        instruction_text = 'Kirjuta vastus j�rgmisele ekraanile ja vajuta ENTER';
    ...
    if training
        goodbye_msg = 'Harjutamine on l�bi. Kas sul on katse kohta k�simusi?';
    else
        goodbye_msg = 'Ait�h katses osalemise eest!';
    end
